...
class OccupiedCarScreen extends StatefulWidget {
  const OccupiedCarScreen({super.key});

  @override
  _OccupiedCarScreenState createState() => _OccupiedCarScreenState();
}

class _OccupiedCarScreenState extends State<OccupiedCarScreen> {
