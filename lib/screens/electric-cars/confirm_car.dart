...
class ConfirmCarScreen extends StatefulWidget {
  const ConfirmCarScreen({super.key});

  @override
  _ConfirmCarScreenState createState() => _ConfirmCarScreenState();
}

class _ConfirmCarScreenState extends State<ConfirmCarScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "El Carro está disponible para tomarlo.",
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ElectricFormScreen(
                          tipo: "TOMA",
                          action: "assign-car/$carCode/$username",
                          reassign: false,
                        ),
                      ),
                    );
